...
class UpdateUsereForm(UserChangeForm):
    password=None
    email = forms.EmailField(label="", max_length=100, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Email Address'}), required=False)
    ...
    def __init__(self, *args, **kwargs):
        super(UpdateUsereForm, self).__init__(*args, **kwargs)
